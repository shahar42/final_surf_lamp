...
description: Monitors and analyzes Render deployment health including service status, recent errors, performance metrics, and deployment history. Automatically invoked when checking deployment health, analyzing service failures, troubleshooting production issues, reviewing deployment status, or investigating Render errors.
allowed-tools: [mcp__render__render_services_status, mcp__render__render_service_events, mcp__render__render_latest_deployment_logs, mcp__render__render_recent_errors, mcp__render__search_render_logs, mcp__render__render_deployments, mcp__render__render_service_status]
