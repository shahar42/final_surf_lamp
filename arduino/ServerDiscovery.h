...
private:
    ...
    const char* discovery_urls[2] = {
        "https://yourusername.github.io/surflamp-discovery/config.json",
        "https://raw.githubusercontent.com/yourusername/surflamp-discovery/main/config.json"
    };
...
private:
    ...
    String attemptDiscovery() {
        ...
        for (int i = 0; i < 2; i++) {
            Serial.printf("   Trying discovery URL %d: %sn", i+1, discovery_urls[i]);
